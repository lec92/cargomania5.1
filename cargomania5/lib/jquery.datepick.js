...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			dayNamesShort: ['Dom', 'Lun', 'Mar', 'Vie', 'Jue', 'Vie', 'Sab'],
			...
			nextJumpStatus: 'Mostrar el siguiente a;o', // Status text for the next year command
			...
			todayStatus: 'Mostrar el mes actual', // Status text for the today's month command
			...
			weekText: 'Se', // Text for week of the year column header
			weekStatus: 'Mostrar semana del año', // Status text for week of the year column header
			dayStatus: 'Seleccionar DD, M d, yyyy', // Status text for selectable days
			defaultStatus: 'Elija una fecha', // Status text shown by default
